<x-overall-layout>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-4">
                <div>
                    ...
                    <ul class="mt-4 space-y-4">
                        <li><a href="{{ route('about') }}" class="text-base text-gray-500 hover:text-gray-900">About Us</a></li>
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-4">
                        <li><a href="{{ route('contact') }}" class="text-base text-gray-500 hover:text-gray-900">Contact Us</a></li>
                        <li><a href="{{ route('faqs') }}" class="text-base text-gray-500 hover:text-gray-900">FAQs</a></li>
                    </ul>
                </div>
                <div>
                    <h3 class="text-sm font-semibold tracking-wider text-gray-600 uppercase">Legal</h3>
                    <ul class="mt-4 space-y-4">
                        <li><a href="{{ route('privacy') }}" class="text-base text-gray-500 hover:text-gray-900">Privacy Policy</a></li>
                        <li><a href="{{ route('terms') }}" class="text-base text-gray-500 hover:text-gray-900">Terms of Service</a></li>
                    </ul>
                </div>
            </div>
    ...
    <script>
        ...
        // Call this function to fetch the updated cart item count from the server (via AJAX or page reload)
        ...
        // Fetch the cart count initially when the page loads
        window.onload = fetchCartItemCount;
    </script>
